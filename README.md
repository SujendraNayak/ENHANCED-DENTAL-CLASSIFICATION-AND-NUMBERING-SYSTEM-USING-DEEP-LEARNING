...
- **Region Proposal Network (RPN):** Generates candidate tooth regions.  
...
git clone https://github.com/your-username/Enhanced-Dental-Classification.git
cd Enhanced-Dental-Classification
